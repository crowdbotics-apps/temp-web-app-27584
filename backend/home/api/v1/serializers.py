...
#         fields = ('id', 'first_name', 'last_name', 'email', 'image', 'competition', 'sports', 'premium_to', 'is_coach', 'date_joined', 'streak', 'foo')
        fields = ('id', 'first_name', 'last_name', 'email', 'image', 'competition', 'sports', 'premium_to', 'is_coach', 'date_joined', 'streak', 'foo','usersID')

    def update(self, instance, validated_data):
      instance.first_name = validated_data.get('first_name', instance.first_name)
      instance.usersID = validated_data.get('usersID', instance.usersID)
...
#         fields = ['id', 'email', 'first_name', 'last_name', 'image', 'premium_to', 'is_coach']
        fields = ['id', 'email', 'first_name', 'last_name', 'image', 'premium_to', 'is_coach','usersID']
